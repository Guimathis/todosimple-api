package com.JavaApiRest.todosimple.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Valor declarado em properties, true: incui a stack trace no erro
            //false: não inclui (recomendado em prod)
    @Value("${server.error.include-exception}")
    private boolean printStackTrace;

    // Handler de exceção campo não preenchido
    ...
    // Handler de exceção desconhecida
    ...
    // Handler para erros de integridade, como usuário inserindo um username não unico.
    ...
    // Handler para violações de regra, como campo em branco ou com caracteres insuficientes
